...
const Generator = ({ addPrediction }) => {
  ...
  const onSubmit = async (e) => {
    ...
    try {
      const response = await axios.post("https://api.forbiddenpixels.com/api/predictions", {
        prompt: prompt,
  ...
  const pollPrediction = async (id) => {
    try {
      const response = await axios.get(`https://api.forbiddenpixels.com/api/predictions/${id}`);
  ...
  const sendGeneratedImages = async (imageUrls) => {
    try {
      ...
      for (const url of imageUrls) {
        await axios.post("https://api.forbiddenpixels.com/api/predictions/save-images", {
          prompt: prompt,
          seed: parseInt(seed.value),
          width: parseInt(width),
          height: parseInt(height),
